/*************************************************************************
	...
	> Author: zhouyingda
	> Mail: 
	> Created Time: Sun 14 Jan 2024 02:21:55 PM CST
 ************************************************************************/
...
#define output_format "%10s%4d%6d%7.2lf"
...
long ouput_to_file(Student *arr, int n) {
...
void add_a_student() {
    ...
    stus[scnt].offset = ouput_to_file(stus + scnt, 1);
    scnt += 1;
